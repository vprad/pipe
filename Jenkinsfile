...
//                 sh "docker login -u AWS -p \$(aws ecr get-login-password --region us-east-1) 126986921526.dkr.ecr.us-east-1.amazonaws.com/testrepo "

//                 sh "docker tag saimanas123/spring-petclinic 126986921526.dkr.ecr.us-east-1.amazonaws.com/testrepo:spring-petclinic-${BUILD_NUMBER}"

//                 sh "docker push 126986921526.dkr.ecr.us-east-1.amazonaws.com/testrepo:spring-petclinic-${BUILD_NUMBER}"
